import "./App.css";
import ProfileImage from "../src/img/pp.jpg";
      ...
      <header className="container mx-auto md:container md:mx-auto  sm:container sm:mx-auto  lg:container lg:mx-auto  xl:container xl:mx-auto pl-4 pr-4">
        <div className="header ">
          ...
          <div className="profile-name mt-4 ">
            <h1 className="font-extrabold	 text-base text-xl tracking-wide text-white">
              Refaldo Rachman
            </h1>
        ...
        <div className="main mt-10 mb-20">
          ...
          <a
            ...
            download="cv refaldo"
          >
            <div className="links bg-emerald-500	p-4 max-w-lg mx-auto mt-3 flex items-center align-middle text-white rounded-full hover:bg-emerald-600	">
              <div className="svg-icon w-1/6 ">
                <svg
                  aria-hidden="true"
                  focusable="false"
